...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\_Projects\test\billing-test\public\storage' => 'string',
            ...
            'laravellocalization.supportedLocales.ru.name' => 'string',
            'laravellocalization.supportedLocales.ru.script' => 'string',
            'laravellocalization.supportedLocales.ru.native' => 'string',
            'laravellocalization.supportedLocales.ru.regional' => 'string',
            'laravellocalization.supportedLocales.hy.name' => 'string',
            'laravellocalization.supportedLocales.hy.script' => 'string',
            'laravellocalization.supportedLocales.hy.native' => 'string',
            'laravellocalization.supportedLocales.hy.regional' => 'string',
            'laravellocalization.useAcceptLanguageHeader' => 'boolean',
            'laravellocalization.hideDefaultLocaleInURL' => 'boolean',
            'laravellocalization.localesOrder' => 'string',
            'laravellocalization.localesMapping' => 'array',
            'laravellocalization.utf8suffix' => 'string',
            'laravellocalization.urlsIgnored' => 'string',
            'laravellocalization.httpMethodsIgnored' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.D:\\_Projects\\test\\billing-test\\public\\storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'ide-helper.macroable_traits','laravellocalization.supportedLocales.en.name','laravellocalization.supportedLocales.en.script','laravellocalization.supportedLocales.en.native','laravellocalization.supportedLocales.en.regional',
'laravellocalization.supportedLocales.ru.name','laravellocalization.supportedLocales.ru.script','laravellocalization.supportedLocales.ru.native','laravellocalization.supportedLocales.ru.regional','laravellocalization.supportedLocales.hy.name',
'laravellocalization.supportedLocales.hy.script','laravellocalization.supportedLocales.hy.native','laravellocalization.supportedLocales.hy.regional','laravellocalization.useAcceptLanguageHeader','laravellocalization.hideDefaultLocaleInURL',
...
'tinker.alias','tinker.dont_alias','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key',
...
'app','components.common.back-to-top','components.common.bg-noise','components.common.cursor','components.common.loading',
'errors.401','errors.402','errors.403','errors.404','errors.419',
'errors.429','errors.500','errors.503','errors.minimal','layouts.default',
'pages.welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
...
'QUEUE_CONNECTION','REDIS_CLIENT','REDIS_HOST','REDIS_USERNAME','REDIS_PASSWORD',
'REDIS_PORT','REDIS_PREFIX','CACHE_STORE','CACHE_PREFIX','MAIL_MAILER',
